...
***************************************************************************** */
     ...
     */
                ...
                if (globalState.inBatch === 0) {
                  ...
                  if (mockup.shouldCompute(this))
                    if (this.trackAndCompute())
                      mockup.propagateChangeConfirmed(this);
                }
            ...
            mockup.addObserver = function(observable, node) {
            ...
            mockup.propagateChanged = function(observable) {
              ...
              while (i--) {
                var d = observers[i];
                if (
                  d.dependenciesState === exports.IDerivationState.UP_TO_DATE
                ) {
            ...
            mockup.propagateChangeConfirmed = function(observable) {
            ...
            mockup.shouldCompute = function(derivation) {
              switch (derivation.dependenciesState) {
                ...
                case exports.IDerivationState.POSSIBLY_STALE: {
                  ...
                  mockup.changeDependenciesStateTo0(derivation);
                  untrackedEnd(prevUntracked);
                  return false;
                }
              }
            ...
            mockup.bindDependencies = function(derivation) {
              ...
              while (i0--) {
                ...
                if (dep.diffValue === 1) {
                  dep.diffValue = 0;
                  mockup.addObserver(dep, derivation);
                }
              }
            ...
            mockup.clearObserving = function(derivation) {
             ...
             *
             */
            mockup.changeDependenciesStateTo0 = function(derivation) {
              if (
                derivation.dependenciesState ===
                exports.IDerivationState.UP_TO_DATE
              )
...
Tracing.traceFn('mockup.shouldCompute')
  ...
  .traceFn('mockup.changeDependenciesStateTo0')
  .traceFn('mockup.addObserver')
  .traceFn('mockup.clearObserving')
  .traceFn('mockup.propagateChanged')
  .traceFn('mockup.propagateChangeConfirmed')
